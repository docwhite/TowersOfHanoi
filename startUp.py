...
""" DISCLAIMER: This startScript.py file is adapted from Jared Auty's scripting project "L-SystemPlant Generator". All the
...
class findPathWindow:
    ...
    def closeAll(self, *args):
        ...
        reload(towersOfHanoi)
        towersOfHanoi.createUI() # Start UI
